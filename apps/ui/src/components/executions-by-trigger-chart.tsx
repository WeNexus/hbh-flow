...
export default function ExecutionsByTriggerChart() {
    ...
    <Card variant="outlined" sx={{ width: '100%' }}>
      <CardContent>
        ...
        <LineChart
          ...
          sx={{
            '& .MuiAreaElement-series-manual': {
              fill: "url('#manual')",
            },
            '& .MuiAreaElement-series-event': {
              fill: "url('#event')",
            },
            '& .MuiAreaElement-series-webhook': {
              fill: "url('#webhook')",
            },
          }}
          hideLegend
        >
          <AreaGradient color={theme.palette.primary.dark} id="manual" />
          <AreaGradient color={theme.palette.primary.main} id="event" />
          <AreaGradient color={theme.palette.primary.light} id="webhook" />
        </LineChart>
      </CardContent>
    </Card>
  );
