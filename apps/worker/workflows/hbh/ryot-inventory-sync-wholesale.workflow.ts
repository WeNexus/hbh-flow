...
@Workflow({
  name: 'HBH - Sync wholesale product stock with Ryot',
  webhook: true,
  concurrency: 1,
  triggers: [
    cron('*/30 * * * *', {
...
export class RyotInventorySyncWholesaleWorkflow extends WorkflowBase {
  constructor(
  ...
  private logger = new Logger(RyotInventorySyncWholesaleWorkflow.name);
