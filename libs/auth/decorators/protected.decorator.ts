 ...
 *
 * @param role - The lowest role required to access the route. If not provided, no authentication is required.
 * @returns The combined decorators for authentication and role-based access control.
 */
export function Protected(role?: Role | 'ANONYMOUS') {
